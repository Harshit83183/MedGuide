...
add(
  ...
  'Describe your problem in your own words. Smart Triage will use your symptoms and context to explain possible causes, urgency and next steps.',
  'अपनी समस्या अपने शब्दों में लिखें। स्मार्ट ट्रायेज आपके लक्षणों और स्थिति को समझकर संभावित कारण, गंभीरता और अगले कदम बताएगा।',
  'तुमची समस्या तुमच्या शब्दांत लिहा. स्मार्ट ट्रायेज तुमची लक्षणे आणि परिस्थिती समजून संभाव्य कारणे, तातडी आणि पुढील पावले सांगेल.',
  'உங்கள் பிரச்சினையை உங்கள் சொற்களில் எழுதுங்கள். ஸ்மார்ட் டிரையாஜ் உங்கள் அறிகுறிகளையும் சூழலையும் புரிந்துகொண்டு சாத்தியமான காரணங்கள், அவசரம் மற்றும் அடுத்த படிகளை விளக்கும்.',
  'আপনার সমস্যা নিজের ভাষায় লিখুন। স্মার্ট ট্রায়াজ আপনার উপসর্গ ও পরিস্থিতি বুঝে সম্ভাব্য কারণ, জরুরিতা এবং পরবর্তী পদক্ষেপ জানাবে।'
);

add(
  'Kam se kam 10 aksharon me apni takleef likhein.',
  'Describe your problem in at least 10 characters.',
  'अपनी समस्या कम से कम 10 अक्षরে लिखें।',
  'तुमची समस्या किमान १० अक्षरांत लिहा.',
  'உங்கள் பிரச்சினையை குறைந்தது 10 எழுத்துகளில் எழுதுங்கள்.',
  'আপনার সমস্যা কমপক্ষে ১০ অক্ষরে লিখুন।'
);

add(
  'AI symptoms analyse kar raha hai...',
  'AI is analysing your symptoms...',
  'AI आपके लक्षणों का विश्लेषण कर रहा है...',
  'AI तुमच्या लक्षणांचे विश्लेषण करत आहे...',
  'AI உங்கள் அறிகுறிகளைப் பகுப்பாய்வு செய்கிறது...',
  'AI আপনার উপসর্গ বিশ্লেষণ করছে...'
);
